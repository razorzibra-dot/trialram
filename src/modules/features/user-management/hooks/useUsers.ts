...
/**
 * NOTE: useRoles() was removed - use useUserRoles() instead
 * Both hooks provided identical functionality and caused duplication
 * useUserRoles() is the standard hook for fetching available roles
 */