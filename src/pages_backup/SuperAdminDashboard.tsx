    ...
    <div className="p-6 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <div className="text-center p-4 rounded-lg border border-neutral-200 bg-white shadow-sm">
            <div className="text-xl font-semibold text-neutral-900">{formatTime(currentTime)}</div>
            <div className="text-sm flex items-center justify-center mt-1 text-neutral-500">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-0 shadow-sm bg-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-neutral-600">Total Tenants</CardTitle>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-neutral-900">{formatNumber(platformUsage?.total_tenants || 0)}</div>
            <div className="flex items-center text-xs mt-1">
              <TrendingUp className="h-3 w-3 mr-1 text-success-500" />
              <span className="font-medium text-success-600">+{platformUsage?.growth.tenants_growth || 0}%</span>
