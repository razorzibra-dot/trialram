      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-0 shadow-sm bg-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-neutral-600">Total Requests</CardTitle>
            <div className="h-8 w-8 rounded-lg bg-accent-100 flex items-center justify-center">
              <UserCheck className="h-4 w-4 text-accent-600" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-neutral-900">{roleRequests.length}</div>
