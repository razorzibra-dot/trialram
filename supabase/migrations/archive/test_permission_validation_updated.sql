-- Updated Permission Insertion and Role Verification Script
...
BEGIN
    ...
    -- Test 1: Check actual permissions count
    DECLARE
        permission_count INTEGER;
    BEGIN
        SELECT COUNT(*) INTO permission_count FROM permissions;
        
        RAISE NOTICE 'Total permissions found: %', permission_count;
        
        IF permission_count >= 80 THEN
            RAISE NOTICE '✅ ALL PERMISSIONS CORRECTLY INSERTED (Database has rich permission system)';
        ELSE
            RAISE EXCEPTION '❌ MISSING PERMISSIONS: Found %, Expected 80+', permission_count;
        END IF;
    END;
    ...
    BEGIN
        ...
        IF correct_format_count >= 70 THEN
    ...
    DECLARE
        ...
        customer_role_id UUID := '10000000-0000-0000-0000-000000000009';
    BEGIN
